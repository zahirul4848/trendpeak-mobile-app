import { StyleSheet, Text, View, TextInput, TouchableOpacity, ActivityIndicator, Dimensions } from 'react-native'
  ...
  return (
    <View>
      ...
      <View style={styles.inputView}>
        ...
        />
        <MaterialIcons style={styles.icon(width > 450 ? 50 : 25)} name="alternate-email" size={24} color={COLORS.secondary} />
      </View>
      <View style={styles.inputView}>
        <TextInput
          style={styles.textInput} 
        ...
        />
        <Fontisto name="locked" size={22} color={COLORS.secondary} style={styles.icon(width > 450 ? 50 : 28)} />
        {isVisible ? 
